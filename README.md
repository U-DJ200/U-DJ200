...
**Does this work with controllers other than the DDJ-200?**
U-DJ200 is purpose-built for the Pioneer DDJ-200's specific layout and MIDI mapping. It is not designed for other controllers.

**What music genres does it support?**
...
No — once installed, U-DJ200 runs fully offline. Track analysis and stem separation both happen locally on your machine.
...
Found a bug, hit an issue with your DDJ-200 setup, or have an idea for a new feature? Open an [issue](../../issues) — feedback from DDJ-200 owners directly shapes what gets built next.
